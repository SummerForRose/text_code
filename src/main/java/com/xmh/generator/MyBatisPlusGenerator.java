...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUrl("jdbc:mysql://localhost:3306/bnztest?useUnicode=true&character_set_server=utf8mb4&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true&allowMultiQueries=true");
...
//        strategy.setSuperEntityColumns("id");
        ...
        strategy.setTablePrefix("t_", "t_sys");
